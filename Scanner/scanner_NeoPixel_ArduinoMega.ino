#include "SoftwareSerial.h"             // Library that enables serial interface
...
//### Pins, physical defs
const uint8_t dataPin = 9;              // Data pin on Arduino for LED Strip
const uint8_t mdataPin = 10;            // Data pin on Arduino for LED Strip
const uint8_t ledPin = 14;              // the number of the LED pin
...
const uint8_t numLEDs = 8;              // How many leds in your strip?
...
bool motionOn = true;                   // Enable or disable the motion sensor
